...
ActiveRecord::Schema.define(version: 20170513010217) do
  ...
  add_index "book_creators", ["book_id"], name: "index_book_creators_on_book_id", using: :btree
  add_index "book_creators", ["creator_id"], name: "index_book_creators_on_creator_id", using: :btree
  ...
  create_table "books", force: :cascade do |t|
    ...
    t.integer  "stilage_id",     null: false
    t.datetime "created_at",     null: false
    t.datetime "updated_at",     null: false
  end

  add_index "books", ["stilage_id"], name: "index_books_on_stilage_id", using: :btree
  ...
  create_table "rooms", force: :cascade do |t|
    t.string   "schort_name", null: false
    t.text     "long_name",   null: false
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
  end

  create_table "stilages", force: :cascade do |t|
    t.integer  "room_id",    null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  add_index "stilages", ["room_id"], name: "index_stilages_on_room_id", using: :btree
  ...
  add_foreign_key "books", "stilages"
  add_foreign_key "role_users", "roles"
  add_foreign_key "role_users", "users"
  add_foreign_key "stilages", "rooms"
end
